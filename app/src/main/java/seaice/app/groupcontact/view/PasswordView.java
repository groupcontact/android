...
public class PasswordView extends EditText {
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        try {
            borderColor = a.getColor(R.styleable.PasswordView_borderColor, defaultBorderColor);
            borderWidth = a.getDimension(R.styleable.PasswordView_borderWidth, defaultBorderWidth);
            borderRadius = a.getDimension(R.styleable.PasswordView_borderRadius, defaultBorderRadius);
            passwordLength = a.getInt(R.styleable.PasswordView_passwordLength, defaultPasswordLength);
            passwordColor = a.getColor(R.styleable.PasswordView_passwordColor, defaultPasswordColor);
            passwordWidth = a.getDimension(R.styleable.PasswordView_passwordWidth, defaultPasswordWidth);
            passwordRadius = a.getDimension(R.styleable.PasswordView_passwordRadius, defaultPasswordRadius);
        } finally {
            a.recycle();
        }
