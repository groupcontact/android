...
public interface MaterialMenu {
    ...
    /**
     * Manually set a transformation value for an {@link seaice.app.groupcontact.materialmenu.MaterialMenuDrawable.AnimationState}
     *
     * @param animationState state to set value in
     * @param value          between {@link seaice.app.groupcontact.materialmenu.MaterialMenuDrawable#TRANSFORMATION_START} and
     *                       {@link seaice.app.groupcontact.materialmenu.MaterialMenuDrawable#TRANSFORMATION_END}.
     */
