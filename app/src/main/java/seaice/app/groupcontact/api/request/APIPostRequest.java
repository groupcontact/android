...
public class APIPostRequest extends StringRequest {
     ...
     * @param errorListener
     */
    public APIPostRequest(String url, Map<String, String> params, final Response.Listener<JSONArray> listener, final Response.ErrorListener errorListener) {
     ...
     * @param listener
     */
    public APIPostRequest(String url, Map<String, String> params, final Response.ErrorListener errorListener, final Response.Listener<JSONObject> listener) {
        super(url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {
